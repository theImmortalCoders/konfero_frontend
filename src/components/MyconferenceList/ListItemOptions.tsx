...
export default function ListItemOptions({confId, handleDelete} : {confId: number, handleDelete: Function}) {
  ...
  return (
    <div className="relative select-none" ref={optionsRef}>
      ...
      <div className={`${open ? 'absolute' : 'hidden'} top-[20px] right-1/2 min-w-60`} ref={optionsRef}>
        <Box>
          <div onClick={() => handleDelete(confId)} className="flex justify-center items-center cursor-pointer">
