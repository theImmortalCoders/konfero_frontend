    ...
    return (
      ...
      <span className="flex w-full justify-center lg:justify-start order-2 lg:order-1 ">
        <Image src={Logo} alt="Logo" className="w-12"/>
            ...
            <span
                className="flex w-full justify-center lg:justify-end items-center space-x-6 mb-6 lg:mb-0 text-darkblue order-1 lg:order-2">
      ...
      <span className="flex w-full justify-center lg:justify-start py-4 lg:py-0 order-2 lg:order-1">
        <p className="font-sans text-xs text-center">
          KONFERO © 2024 Wszelkie prawa zastrzeżone
            ...
            <span
                className="flex flex-col space-y-3 xs:space-y-0 xs:flex-row xs::row-span-3 lg:flex-nowrap w-full justify-center lg:justify-end items-center xs:space-x-6 order-1 lg:order-2">
