...
import {appAPI, NEXT_PUBLIC_FRONT_BASE_URL} from "@/utils/appENV";
    ...
    return (
        <div className="flex flex-col justify-center items-center text-center text-darkblue">
            ...
            <a href={`${appAPI.defaults.baseURL}/api/oauth2/authorize/google`}>
                <div
                    className="flex justify-center items-center w-full md:w-96 h-16 text-close2White text-lg bg-blue rounded-2xl px-8">
