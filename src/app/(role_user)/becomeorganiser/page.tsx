...
function Description ({ children }: { children: React.ReactNode }) {
    return (
        <p className="text-xs md:text-lg xl:text-base text-center">{ children }</p>
    )
  }
        ...
        <Page>
            <Box className="flex flex-col md:flex-row items-center w-[90%] lg:w-[75%] xl:w-[60%] text-darkblue space-x-0 md:space-x-8">
                ...
                <div className="flex flex-col items-center justify-center">
                    ...
                    <button className="text-nowrap w-auto bg-blue text-close2White text-lg font-medium py-2 px-6 rounded-3xl ">Poproś o dostęp</button>
                </div>
            </Box>
        </Page>
    )
